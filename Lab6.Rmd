...
In this lab, you will explore the `who` dataset which comes with `tidyr`. Let's first load the `tidyverse` package collection that contains `tidyr`, `dplyr` and `ggplot2` which we will need today:
